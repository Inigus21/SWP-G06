...
public class UserDAO {
    ...
    /**
     * Find a user by email regardless of whether they are banned (is_delete
     * status) Used for checking if email exists before creating a new account
     */
    ...
    public int getTotalUsers(String searchQuery, Integer roleFilter, Boolean statusFilter)
    ...
    public java.util.List<User> getAllUsers(int page, int pageSize, String searchQuery, Integer roleFilter,
            Boolean statusFilter, String sortBy, String sortOrder) throws SQLException, ClassNotFoundException {
