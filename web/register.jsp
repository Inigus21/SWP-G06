...
<body>
    ...
    <div id="webcrumbs">
        <div class="w-[800px] flex bg-white rounded-lg overflow-hidden shadow-xl">
            ...
            <div class="w-1/2 p-8">
                <h3 class="text-2xl font-semibold mb-6">Đăng ký</h3>
                <form class="space-y-4" action="register" method="POST">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="agreement" class="h-4 w-4 text-blue-500" />
                        <span class="ml-2 text-sm">Tôi đồng ý với các điều khoản và điều kiện</span>
                    </div>
                    <button type="submit"
