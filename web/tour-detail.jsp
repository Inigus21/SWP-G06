                            ...
                            <div class="flex items-center">
                                ...
                                <c:if test="${promotion != null}">
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm mt-1">Đặt ngay để nhận được ưu đãi giữ chỗ</p>
                                    </div>
                                </c:if>
                                <c:if test="${promotion == null}">
                                    <p class="text-red-500 font-medium">Đặt ngay để nhận được ưu đãi giữ chỗ </p>
                                </c:if>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-red-600 font-medium">${trip.availableSlot} </span>
                                </div>
                            </div>
