                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="date" class="form-control" id="returnDate${trip.id}" name="returnDate" 
                                                                       value="${trip.returnDate != null ? trip.returnDate : ''}" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="time" class="form-control" id="startTime${trip.id}" name="startTime" 
                                                                       value="${trip.startTime != null ? trip.startTime : ''}" required>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="time" class="form-control" id="endTime${trip.id}" name="endTime" 
                                                                       value="${trip.endTime != null ? trip.endTime : ''}" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" class="form-control" id="availableSlot${trip.id}" name="availableSlot" 
                                                                       value="${trip.availableSlot != null ? trip.availableSlot : 0}" min="0" max="${tour.maxCapacity}" required>
                                                            </div>
                                                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="status" name="status">
                                    <option value="Inprogrcess" selected>Inprogress</option>
